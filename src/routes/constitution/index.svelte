...
<div class="constitution">
    ...
    <p>10 Bench (Plus a 4 person taxi squad of Rookies and 1st year players only)</p>

    <p>2 IR Spots (Player must be labeled as IR or Covid in the Sleeper App)</p>
    ...
    <p>Trading of players and draft picks (up to 2 drafts away) are allowed. Trades will process after 1 day and will be reversed if vetoed or under investigation for collusion. The commissioner can push a trade through a trade at any time if neccessary. Tradable assets include players, draft picks, and FAAB $.</p>
    
    <h4 bind:this={oneTwoOne}>1.2.1 Trade Collusion</h4>
    <div class="subBlock">
        <p>If any owners are suspected of accepting bribes/offering bribes to enhance their/another owners team via trade or otherwise found guilty of engaging in any form of collusion*, all parties involved in the trade will be susceptible to punishment. The punishments will go as followed:</p>
    ...
    <div class="subBlock">
        <p>There will be no trade deadline to start. If the league owners are in favor, a majority vote will be needed.</p>
    </div>
    
    <h4 bind:this={oneTwoFour}>1.2.4 Trade Restrictions</h4>
    <div class="subBlock">
        <p>You will not be able to trade draft picks that are more than 2 drafts away. For example, during the 2021 season you cannot trade any picks in or after the 2024 draft. You may only trade FAAB $ from the current season.</p>
    </div>
    
    <h4 bind:this={oneTwoFive}>1.2.5 Veto/Trade Process</h4>
    <div class="subBlock">
        <p> Vetoes are only appropriate in instances of collusion or an egregious mismatch of value. Not liking a trade does not warrant a veto. If you are in favor of a veto, DM the commissioner or provide thoughts in the league chat.</p>
        <p> A league poll will be used and a majority will be need to reverse the trade. The commissioner will be the tie breaking vote.</p>
    </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $250. $0 bids are allowed. Bids will process Wednesdays around 2am CST.</p>
    <p>A player will need to pass through waivers after being released or after the conclusion of that weeks games. After the waiver process, the player will be considered a free agent.</p>
    ...
    <p>The draft order each year will be a linear draft in reverse order of the previous year’s maximum points for. This takes into consideration your bench players points not just your starters points.</p>

    <h3 bind:this={twoTwo}>2.2 Rookie Drafts</h3>
    <p>Rokkie drafts will consist of 4 round of drafting, with 2 minutes alotted for each pick. To make room for the incoming players, benches will be expanded by (4) spots. In order to make roster adjustments, you will need to have a legitimate roster of 19 active players (not including IR).</p>
    <p>You will have until the first regular season game to add players to your taxi squad. After the start of the regular season, you will no longer be able to add players, only remove them.</p>
    ...
    <p>Standard playoff formatting will be the top 6 teams based on overall record. The top 2 teams will recieve a first round by. Each round will consist of 1 week with the exception of the Championship round which will consist of 2 weeks.</p>
    <p>2021 ADDENDUM: At the end of the season 4 teams will make the playoffs. The first round of playoffs will commence in week 15. The top 4 teams that finish with the best records, will receive a playoff berth. The rest of the 6 teams will play in a consolation bracket. Each playoff matchup will only last one week and the winner will advance. Week 18 will not be used.</p>
    <p>Playoff brackets may change on a year-to-year basis based on the NFL's bye week schedule. A league vote will be used to determine any changes.</p>
    ...
    <ul>
        ...
        <li>2nd place: $75</li>
        <li>3rd place: $50</li>
        <li>Regular Season: $75</li>
    </ul>
    <p>The league also has a rolling jackpot. Half of the league dues are put into the jackpot every year. If an owner wins in consecutive years, the payout schedule is as follows:</p>
    <ul>
        <li>2 Years in a Row: 50%</li>
        <li>3 Years in a Row: 50%</li>
        <li>4 Years in a Row: 50%</li>
    </ul>
